---
title: "COGS137 Final Project: San Diego Automobile Accidents 2016-2021"
...
- Wrangled SD crash data set: 47,806 observations and 37 variables
...
```{r, eval = FALSE}
crash <- crash |>
  select("ID", "Day", "Month", "Year", "Date", "Zipcode", "County", "City", "Severity", "Latitude", "Longitude", "Distance", "Side", "Time_of_day", "Temperature", "Wind_chill", "Humidity", "Pressure", "Visibility", "Wind_direction", "Wind_speed", "Precipitation", "Weather_condition", "Weather_category", "Amenity", "Bump", "Crossing", "Give_way", "Junction", "No_exit", "Railway", "Roundabout", "Station", "Stop", "Traffic_calming", "Traffic_signal", "Turning_loop")
```
...
#### Question 1: FILL QUESTION 1 IN HERE
...
#### Question 2: FILL QUESTION 2 IN HERE
